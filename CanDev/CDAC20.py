...
DAC_pos_up_code = 0xfffff8
DAC_pos_up_volt = 10.
DAC_pos_low_code = 0x800000
DAC_pos_low_volt = 0.000005

DAC_neg_up_code = 0x7ffff8
DAC_neg_up_volt = -0.000005
DAC_neg_low_code = 0x000000
DAC_neg_low_volt = -10
...
class CDAC20(Device_pattern.Device_pattern):
    ...
    def __init__(self, event, send_addr=def_send, recv_addr=def_recv, id=def_id, dev_code=def_code, hw_ver=def_hw_ver,
                 sw_ver=def_sw_ver, ADC_n=20, DAC_n=5, in_reg=8, out_reg=8, read_input_flag=True, random_regs_flag=False, random_ADC_flag=False):
        """Constructor"""
    ...
    def x05_cmd(self, data):
        return

    def x06_cmd(self, data):
        return

    def x07_cmd(self, data):
        return
